...
public abstract class Herbivore extends Animal {
	...
	private static final int DEFAULT_NUM_OF_HERBIVORES = 4;
	...
	public Herbivore(int animal_id, HerbivoreName randomName, int age, double weight, double height, Pattern pattern,
	...
	public Herbivore(int animal_id, String name, int age, double weight, double height, Pattern pattern, Sex sex,
			int happiness) {
		super(animal_id, age, happiness);
		this.name = name;
		this.weight = weight;
	...
	public int getDefaultNumberOfAnimals() {
		return getDefaultNumOfHerbivores();
	}
	...
	public String toString() {
		...
		return String.format("%s - [Name: %s | Age: %d | Weight: %.2f | Pattern: %s | Gender: %s]  -  Happines: %d ",
				getClass().getSimpleName(), displayName, age, weight, pattern, sex, happiness);
	}

	public static int getDefaultNumOfHerbivores() {
