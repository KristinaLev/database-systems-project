...
public abstract class Bird extends Animal {
	...
	private static final int DEFAULT_NUM_OF_BIRDS = 4;

	protected BirdsName randomName;
	protected String name;
	protected double height;

	public Bird(int animal_id, BirdsName randomName, int age, double height, int happiness) {
		super(animal_id, age, happiness);
		this.randomName = randomName;
		this.height = height;
	}

	public Bird(int animal_id, String name, int age, double height, int happiness) {
		super(animal_id, age, happiness);
		this.name = name;
		this.height = height;
	}
	...
	public String toString() {
		...
		return String.format("%s - [Name: %s | Age: %d | Height: %.2f]  -  Happines: %d ", getClass().getSimpleName(),
				displayName, age, height, happiness);
	}

	public static int getDefaultNumOfBirds() {
