...
public abstract class Reptile extends Animal {
	...
	private static final int DEFAULT_NUM_OF_REPTILE = 5;
	...
	public Reptile(int animal_id, ReptilesName randomName, int age, double weight, double length, StatusCheck venomous,
	...
	public Reptile(int animal_id, String name, int age, double weight, double length, StatusCheck venomous,
			Colors[] color, StatusCheck ninja, int happiness) {
		super(animal_id, age, happiness);
		this.name = name;
		this.weight = weight;
	...
	public static int getDefaultNumOfReptile() {
